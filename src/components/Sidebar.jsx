...
const NAV = [
  { to: '/', label: 'Dashboard', icon: 'D', accent: 'bg-cyan-400' },
  { to: '/guards', label: 'Guards', icon: 'G', accent: 'bg-emerald-400' },
  { to: '/checkpoints', label: 'Checkpoints', icon: 'C', accent: 'bg-sky-400' },
  { to: '/routes', label: 'Routes', icon: 'R', accent: 'bg-indigo-400' },
  { to: '/schedules', label: 'Schedules', icon: 'S', accent: 'bg-amber-400' },
  { to: '/logs', label: 'Patrol Logs', icon: 'L', accent: 'bg-teal-400' },
  { to: '/incidents', label: 'Incidents', icon: 'I', accent: 'bg-rose-400' }
];
